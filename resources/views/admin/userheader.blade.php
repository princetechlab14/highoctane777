            ...
            <div class="row">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title mb-0">Edit User Header</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ url('admin') }}/userheader" role="form"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <textarea id="headercode" name="newheader">{{ $header }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var htmlEditor = CodeMirror.fromTextArea(document.getElementById("headercode"), {
                lineNumbers: true,
                mode: 'htmlmixed',
                theme: 'darcula',
            });
